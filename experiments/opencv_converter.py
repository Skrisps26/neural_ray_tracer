...
# --- FIX: ENABLE OPENEXR ---
# We must set this flag BEFORE using cv2 to unlock EXR loading
...
def load_exr_cv2(path):
    ...
    # IMREAD_UNCHANGED loads the Float16/32 data directly
    try:
...
def save_chunk(data, scene, idx):
    ...
    # Helper to stack and convert to Float16 Tensor
